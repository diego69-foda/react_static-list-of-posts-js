export const PostInfo = () => (
  <div className="PostInfo">
    ...
    <p className="PostInfo__body">
      ...
      ratione ut eos beatae quibusdam distinctio maiores earum voluptates et aut
    ...
    <div className="CommentList">
      <div className="CommentInfo">
        ...
        <div className="CommentInfo__body">
          dolorum voluptas laboriosam quisquam ab totam beatae et aut optio
      ...
      <div className="CommentInfo">
        ...
        <div className="CommentInfo__body">
          quia molestiae reprehenderit quasi aspernatur aut expedita aliquam
          aliquam eveniet laudantium omnis quibusdam delectus saepe quia
          accusamus maiores nam est cum et ducimus et vero voluptates voluptates
